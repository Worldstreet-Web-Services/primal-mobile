...
const stages: Stage[] = [
  {
    title: "Quote locked",
    sub: "14:02 · spread baked into rate",
    state: "done",
    link: "done",
  },
  {
    title: "₦ debited",
    sub: "14:02 · idempotency-keyed",
    state: "done",
    link: "toAmber",
  },
  {
  ...
  return (
    <View
      style={{
        ...
        borderRadius: 12,
        borderWidth: 2,
        borderColor: "rgba(199,204,209,0.25)",
      }}
    />
  );
}
    ...
    <Screen>
      ...
      >
        ...
        <View>
          ...
          <Mono size={10.5} color={C.dim} style={{ marginTop: 1 }}>
      ...
      <View style={{ marginTop: 24 }}>
        ...
        >
          Pricing comes from the provider quote — Paradigm never adds a
          client-side fee.
        </Body>
      </View>
    </Screen>
