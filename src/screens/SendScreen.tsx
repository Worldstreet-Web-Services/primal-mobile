  ...
  return (
    <View
      style={{
        ...
        height: 40,
        borderRadius: 21,
        backgroundColor: dim ? "rgba(255,255,255,0.08)" : C.upBg,
        alignItems: "center",
  ...
  return (
    ...
    >
      ...
      <View style={{ flex: 1 }}>
        ...
        <Mono size={11.5} color={C.sub} style={{ marginTop: 2 }}>
          {r.sub}
        </Mono>
      </View>
      {r.internal ? (
        <View
          style={{
            ...
            borderRadius: 99,
            borderWidth: 1,
            borderColor: "rgba(124,231,176,0.4)",
            backgroundColor: C.upBg,
          }}
        >
          <Body size={9.5} color={C.up} semibold>
            Paradigm
          </Body>
        </View>
      ) : (
        <Body size={10} color={C.up} semibold>
          Name enquiry ✓
        </Body>
      )}
    </Pressable>
      ...
      <Screen>
        ...
        {tab === 0 ? (
          <View style={{ marginTop: 20 }}>
            ...
            >
              @tag transfers land instantly · free between Paradigm accounts
            </Body>
          </View>
        ) : (
          <View style={{ marginTop: 20 }}>
            ...
            >
              ...
              >
                <Mono size={12} style={{ fontFamily: F.monoSemibold }}>
                  GT
                </Mono>
              </View>
              <View style={{ flex: 1 }}>
            ...
            <Card style={{ marginTop: 10, paddingVertical: 14 }}>
              ...
              <Mono size={18} color={C.text} style={{ marginTop: 8 }}>
                0123 456 789
              </Mono>
              <Body size={11} color={C.dim} style={{ marginTop: 6 }}>
                10-digit NUBAN · name enquiry runs automatically
              </Body>
            </Card>
  ...
  return (
    <View style={{ flex: 1, backgroundColor: C.canvas }}>
      ...
      <View style={{ marginTop: 28, alignItems: "center" }}>
        ...
        <Mono size={12} color={C.sub} style={{ marginTop: 6 }}>
          {usdApprox(digits)}
        </Mono>
        <Body size={11} color={C.dim} style={{ marginTop: 10 }}>
          Balance {balance} · fee shown at confirm
        </Body>
      </View>
      <View
