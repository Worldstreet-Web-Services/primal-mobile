        ...
        {tab === 0 ? (
          <View>
            <View style={{ marginTop: 20 }}>
              <QrBox size={150} label="QR · account details" />
            </View>
            <Mono
              size={26}
              color={C.text}
            ...
            >
              Anyone can bank-transfer to this number.{"\n"}Funds land as your
          ...
          <View>
            ...
            <Body
              ...
              style={{ textAlign: "center", marginTop: 14, lineHeight: 17.5 }}
            >
              Balance credits the moment conversion clears — before settlement.
              {"\n"}Failed conversions refund on-chain and always show in
              Activity.
            </Body>
          </View>
        )}
