...
import { Screen, BackHeader, MetallicButton, GhostButton, Label, Mono, Body, Display, TxRow, Card } from '../components/ui';
  ...
  return (
    <Screen>
      ...
      <View style={{ marginTop: 26 }}>
        <Body size={11.5} color={C.dim}>Available balance</Body>
        <Display size={46} style={{ marginTop: 6 }}>₦482,650<Display size={26} color={C.dim}>.00</Display></Display>
        <Mono size={12} color={C.sub} style={{ marginTop: 8 }}>≈ $312.40 USD</Mono>
        <Card style={{ marginTop: 14, alignSelf: 'flex-start', flexDirection: 'row', alignItems: 'center', gap: 9, paddingVertical: 9, paddingHorizontal: 13, borderRadius: 12 }}>
          <Mono size={12.5}>{user.va} · {user.bank}</Mono>
